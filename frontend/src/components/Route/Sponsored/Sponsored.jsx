  ...
  return (
    <div className={`${styles.section} hidden sm:block bg-white py-10 px-5 mb-12 cursor-pointer rounded-xl`}>
            <div className="flex justify-between w-full">
                ...
                <div className="flex items-start">
                    <img src="https://images.squarespace-cdn.com/content/v1/502a8efb84ae42cbccf920c4/1585574686746-VCDIHSO21O76WR72WIAD/LG-Logo.png?format=2500w" alt="" 
                    style={{ width: '150px', objectFit:"contain" }}
                    />
                </div>
                <div className="flex items-start">
                    <img src="https://cdn.icon-icons.com/icons2/2699/PNG/512/apple_logo_icon_168588.png" alt="" 
                    style={{ width: '150px', objectFit:"contain" }}
                    />
                </div>
                <div className="flex items-start">
