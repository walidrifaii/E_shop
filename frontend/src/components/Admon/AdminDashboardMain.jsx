   ...
   <>
   {
    ...
    <div className="w-full block 800px:flex items-center justify-between">
       <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
         ...
         <h5 className="pt-2 pl-[36px] text-[20px] font-[500]">${adminBalance}</h5>
       ...
       <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
         ...
         <h5 className="pt-2 pl-[36px] text-[20px] font-[500]">{sellers && sellers.length}</h5>
       ...
       <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
         ...
         <h5 className="pt-2 pl-[36px] text-[20px] font-[500]">{ adminOrders && adminOrders.length}</h5>
