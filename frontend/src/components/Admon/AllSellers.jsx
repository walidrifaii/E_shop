...
const AllSellers = () => {
            ...
            renderCell: (params) => {
              return (
                <>
                    ...
                    <Button onClick={() => setSellerId(params._id) || setOpen(true)}>
  ...
  return (
    <div className='w-full flex justify-center pt-5'>
        <div className="w-[95%]">
        <h3 className="text-[20px] font-Poppins pb-2"> Latest sellers</h3>
        ...
        open && (
            ...
            <div className="w-[95%] 800px:w-[40%] min-h-[20vh] bg-white rounded shadow p-5">
               ...
               <div className="w-full flex items-center justify-center">
                ...
                <div className={`${styles.button} text-white text-[18px] !h-[42px] ml-4`} onClick={handleDeleted(sellerId) || setOpen(false)}>
                    confirm
                </div>
               </div>
            </div>
